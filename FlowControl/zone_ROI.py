...
class ZoneRoiController:
    def __init__(self, Core: Core, Interface: Interface):
        ...
        self.obj_CameraRoiInterface = self.obj_Interface.dict_frames["zone_roi"]
        self.obj_CameraRoiInterface.obj_Core = self.obj_Core
        self.load_rois_from_db()
        self.load_cameras_from_db()
        # self.obj_CameraRoiInterface.button_back.configure(command=self.on_click_back_button)
        self.obj_CameraRoiInterface.save_button.configure(command=self.onclick_save)
    ...
    def on_click_back_button(self):
            self.obj_HomeController.onclick_submenu_button('camera')

    def onclick_save(self):
         self.obj_CameraRoiInterface.save_roi()