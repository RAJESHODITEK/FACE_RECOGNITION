...
class EditProfileController:
    ...
    def bind_buttons(self) -> None:
        ...
        self.obj_EditUserInterface.checkbox_dev_mode.configure(command=self.toggle_developer_mode)

    def toggle_developer_mode(self):
        if self.obj_EditUserInterface.developer_mode.get():
            print("Developer Mode Enabled!")
            self.obj_Interface.dict_frames['notification'].label_heading_for_miss.grid(row=0, column=1, padx=10, pady=(15, 0), sticky="w")
        else:
            print("Developer Mode Disabled!")
            self.obj_Interface.dict_frames['notification'].label_heading_for_miss.grid_forget()
