...
from FR_Detection.merge import update_person_mean, add_person_mean, delete_person, perform_recognition_for_validation
...
class personListController:
    ...
    def __init__(self, Core: Core, Interface: Interface):
        ...
        self.mtcnn=MTCNN(keep_all=True,min_face_size=80,thresholds=[0.7,0.8,0.9] ,factor=0.9,device= 'cuda' )

        self.current_image_index = 0
        self.resnet=InceptionResnetV1(pretrained='vggface2').eval().to(self.DEVICE)
        self.more_face=0
        self.mtcnnValidation = MTCNN(keep_all=True, post_process=True, device=self.DEVICE)
