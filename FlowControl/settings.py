...
class SettingsController:
    ...
    def onclick_cancel(self) -> None:
        """Handle cancel button click by clearing all input fields"""
        ...
        # Remove focus from all entry fields to show placeholder text
        self.settings_interface.focus_set()  # This moves focus to the main frame