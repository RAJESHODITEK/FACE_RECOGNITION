...
class Event():
    ...
    def fetch_events(self, i_start_index: int, dict_filter_criteria: dict):
        ...
        try:
            ...
            if (dict_filter_criteria["str_start_timeperiod"] == "" and dict_filter_criteria[
                ...
                query = f"""SELECT vehicle_img, number_plate_img, vehicle_id, number_plate_color, country, time, status,alarm,acknowledgment_message,acknowledgment_time,event_id, camera_name,object_type
    ...
    def today_entry_exit_count(self):
        """
        Fetches today's entry and exit count from the database.
        """
        entry_count = exit_count = 0
        try:
            ...
            print(f"Error fetching today's counts: {e}")
            return entry_count, exit_count
