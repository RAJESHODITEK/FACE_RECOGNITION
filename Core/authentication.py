...
class Authentication():
    ...
    def check_signin_credential(self, str_emailid: str, str_password: str) -> dict:
        ...
        try:
            ...
            select_query = f"SELECT * FROM [{self.dict_db_details['str_db_name']}].[dbo].[{self.dict_db_details['str_user_table']}] WHERE user_name = ?"""
            ...
            if user_data:
                ...
                dict_status["str_error_msg"] = "There is no user registered with given credentials."
