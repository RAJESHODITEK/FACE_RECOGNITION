...
from .audio_manager import AudioManagerInterface
from .camera_roi import CameraRoiInterface
...
from .add_vehicle import AddVehicleInteface
from .vehicle_list import VehicleListInteface
from .delete_vahicle import DeleteVehicleInteface
from .edit_profile import EditUserInterface
from .create_user import CreateUserInterface
from .error import ErrorInterface
from .live_feed import LiveEventInterface
from .camera_manager import  CameramanagerInterface
...
class Interface:
    ...
    def __init__(self):
        ...
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, EditUserInterface, "edit_user")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, CreateUserInterface, "create_user")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, DeleteVehicleInteface, "delete_vehicle")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, VehicleListInteface, "vehicle_list")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, AddVehicleInteface, "add_vehicle")
        ...
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, CameraRoiInterface, "camera_roi")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, CameramanagerInterface, "camera_manager")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, AudioManagerInterface, "audio_manager")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, NotificationInterface, "notification")
