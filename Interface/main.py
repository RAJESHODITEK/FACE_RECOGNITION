...
from .add_person import AddpersonInteface
from .person_list import PersonListInteface
from .delete_person import DeletepersonInteface
...
class Interface:
    ...
    def __init__(self):
        ...
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, DeletepersonInteface, "delete_person")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, PersonListInteface, "person_list")
        self.add_frame(self.dict_frames["home"].frame_rcol_mrow, AddpersonInteface, "add_person")
