...
class VehicleListInteface(CTkFrame):
    ...
    def sort_column(self, column_name, order):
        if column_name in self.dict_columns_buttons:
            print(f"Sorting for column: {column_name}")
            ...
            if order:  # If order is True, use descending sort icon
                image_path = "D:/FR/myenv/Resources/images/desc.png"
                ...
                image_path = "D:/FR/myenv/Resources/images/asc.png"
                image = Image.open(image_path)
                image = image.resize((18, 18))  # Resize image to 15x15 pixels
    ...
    def update_table(self, list_vehicle_data: list):
        ...
        for row_index, row_data in enumerate(list_vehicle_data):
            ...
            if full_name in self.selected_face_set: # check whether the vehicle is selected or not  dt :18-03-2025
                checkbox.select()
...
#----------------------------------------------------[Add Vechile]---------------------------------------------------------------------------------------------------
    ...
    def Add_Form(self, data=[], user_id=None):
        ...
        self.img_uplaod = CTkImage(Image.open(".\\Resources\\images\\Group 405.png"), size=(25, 25))
    ...
    lambda event: self.popup_Add_dropdown(self.frame_form_rcol, self.list_gender, 
        ...
        self.label_error1.grid(row=7, column=0, columnspan=2, sticky="nsew", padx=5, pady=10)
        ...
        self.label_error.grid(row=3,columnspan=2, padx=(15,1))
        ...
        self.button_cancel1.grid(row=5, column=1, padx=4, pady=(25,25), sticky="w")
    ...
    def popup_Add_dropdown(self, parent_frame: CTkFrame, list_data: list = [], entry_destination: CTkEntry = None, i_row: int = None, i_rowspan: int = 3, type: int = 0):
            ...
            if type == 1:
                ...
                for index, row_data in enumerate(list_data):
                    ...
                    # Show the dropdown
                    frame_Add_maindropdown_window.grid_propagate(False)
                    frame_Add_maindropdown_window.grid(row=i_row, column=0, rowspan=i_rowspan, sticky="nsew", padx=(5, 7), pady=(5, 0))
    ...
    def edit_vechile(self, vehicle=[]):
        ...
        self.Edit_img_uplaod = CTkImage(Image.open(".\\Resources\\images\\Group 405.png"), size=(25, 25))
        ...
        self.label_error2.grid(row=7, column=0, columnspan=2, sticky="nsew", padx=5, pady=10)
        ...
        self.Edit_label_error.grid(row=3,columnspan=2, padx=(60,1))
        ...
        self.button_cancel2.grid(row=5, column=1, padx=4, pady=(25,25), sticky="w")
            ...
            if self.current_open_dropdown == entry_destination:
                ...
                for index, row_data in enumerate(list_data):
                    button_options = CTkButton(
                        ...
                        hover_color="#F6F6F6",
                        anchor="w",
                        command=lambda selected_option=row_data: self.Edit_select_option(selected_option, entry_destination, frame_Edit_maindropdown_window)
                    )
                    button_options.grid(row=index, column=0, sticky="nsew", padx=1)
