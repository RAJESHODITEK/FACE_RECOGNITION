...
class AddCameraInterface(CTkFrame):
    def __init__(self, *args, root_width: int = 1920, root_height: int = 1080, **kwargs):
        ...
        i_form_height = int(root_height * 0.88)
        ...
        self.label_url.grid(row=4, column=0, columnspan=2, padx=25, pady=(10, 0), sticky="ew")

        self.Entry_url = CTkEntry(
            self.frame_form,
            height=40,
            fg_color="#F6F6F6",
            placeholder_text="Enter Camera URL",
            placeholder_text_color="#828282",
            text_color="#414141",
            border_color="#DEDEDE",
            border_width=2,
        ...
        self.Entry_url.grid(row=5, column=0, columnspan=2, padx=25, sticky="ew")

        # OR label
        self.label_or = CTkLabel(
            self.frame_form,
            text="OR",
            text_color="#2C2C2C",
            font=("", 14, "bold"),
        ...
        self.label_or.grid(row=6, column=0, columnspan=2, padx=25, pady=(10, 10), sticky="ew")
        ...
        self.label_IP.grid(row=7, column=0, columnspan=2, padx=25, pady=(0, 0), sticky="ew")
        ...
        self.Entry_IP.grid(row=8, column=0, columnspan=2, padx=25, sticky="ew")
        ...
        self.label_port.grid(row=9, column=0, columnspan=2, padx=25, pady=(10, 0), sticky="ew")
        ...
        self.Entry_port.grid(row=10, column=0, columnspan=2, padx=25, sticky="ew")
        ...
        self.label_username.grid(row=11, column=0, columnspan=2, padx=25, pady=(10, 0), sticky="ew")
        ...
        self.Entry_username.grid(row=12, column=0, columnspan=2, padx=25, sticky="ew")
        ...
        self.label_password.grid(row=13, column=0, columnspan=2, padx=25, pady=(10, 0), sticky="ew")
        ...
        self.Entry_password.grid(row=14, column=0, columnspan=2, padx=25, sticky="ew")
        ...
        self.button_save.grid(row=15, column=0, padx=(25, 3.125), pady=(20, 25), sticky="e")
        ...
        self.button_cancel.grid(row=15, column=1, padx=(3.125, 25), pady=(20, 25), sticky="w")