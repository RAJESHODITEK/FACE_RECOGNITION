...
from customtkinter import CTkFrame, CTkLabel, CTkButton, CTkEntry, CTkCanvas, StringVar, CTkCheckBox
...
class EditUserInterface(CTkFrame):
    def __init__(self, *args, root_width: int = 1920, root_height: int = 1080, **kwargs):
        ...
        self.button_save.grid(row=6, column=0, padx=(25, 3.125), pady=(30, 20), sticky="e")
        ...
        self.button_cancel.grid(row=6, column=1, padx=(3.125, 25), pady=(30, 20), sticky="w")
        # Create the Developer Mode variable
        self.developer_mode = BooleanVar(value=False)  # Use CTkBooleanVar

        # Developer Mode Checkbox
        self.checkbox_dev_mode = CTkCheckBox(
            self.frame_form,
        ...
        # Place checkbox below the button
        self.checkbox_dev_mode.grid(row=7, column=0, padx=(25, 3.125), pady=(0, 25), sticky="w")
