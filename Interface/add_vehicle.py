...
class AddVehicleInteface(CTkFrame):
    ...
    def __init__(self, *args, root_width : int = 1920, root_height : int = 1080, **kwargs):
        ...
        self.entry_owner = CTkEntry(
            ...
            height = x,
            fg_color = "#F6F6F6",
            placeholder_text = "Enter Vehicle Owner Number",
            placeholder_text_color =  "#828282",
            text_color="#414141",
            border_color = "#DEDEDE",
            border_width = 2,
    ...
    def reset_interface(self):
        ...
        self.entry_model.configure(placeholder_text = "Enter Vehicle Model")
        self.entry_number.configure(placeholder_text = "Enter Vehicle Number")
        self.entry_color.configure(placeholder_text = "Enter Vehicle Color")
        self.entry_date.configure(placeholder_text = "Enter Manufacturing Year")
        self.entry_owner.configure(placeholder_text = "Enter Vehicle Owner")
